...
//    #endif
    ...
    .def("launch", &igl::opengl::glfw::Viewer::launch, py::arg("resizable") = true,
      py::arg("fullscreen") = false, py::arg("hidden") = false,
      py::arg("name") = "libigl viewer", py::arg("windowWidth") = 1280, py::arg("windowHeight") = 800)
    .def("launch_init", &igl::opengl::glfw::Viewer::launch_init, py::arg("resizable") = true,
      py::arg("fullscreen") = false, py::arg("hidden") = false, py::arg("name") = "libigl viewer",
