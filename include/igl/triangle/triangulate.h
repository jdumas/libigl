...
namespace igl
{
  namespace triangle
  {
    ...
    //   flags  string of options pass to triangle (see triangle documentation)
    // Outputs:
    //   V2  #V2 by 2 coordinates of the vertices of the generated triangulation
    //   F2  #F2 by 3 list of indices forming the faces of the generated triangulation
    //   E2  #E2 by 2 list of indices forming the constrained edges of the generated triangulation
    //   VM2  #V2 list of markers for output vertices
    //   EM2  #E2 list of markers for output constrained edges
    //
    template <
      typename DerivedV,
      typename DerivedE,
